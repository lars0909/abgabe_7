...
function germany(){
    ...
    (document.querySelector(".chart") as HTMLDivElement).style.height= (people_deutschland/ people_eu * 100)+"%";
}
...
function france(){
    ...
    (document.querySelector(".chart") as HTMLDivElement).style.height= (people_frankreich/ people_eu * 100)+"%";
}
...
function austria(){
    ...
    (document.querySelector(".chart") as HTMLDivElement).style.height= (people_oesterreich/ people_eu * 100)+"%";
}
...
function italy(){
    ...
    (document.querySelector(".chart") as HTMLDivElement).style.height= (people_italien/ people_eu * 100)+"%";
}
